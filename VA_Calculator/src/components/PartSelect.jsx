...
const PartSelect = (props) => {
  ...
  let {part, setPart, partDisplay, setPartDisplay} = props;
  ...
  const partClick = (partStr) => {
    ...
    setPart((elem) => {elem = newParts; return elem})
      ...
      <div class="my-4">
        ...
        >
          <path
            ...
            style={props.part().torso ? highlight : ''}
            onClick={() => {
              partClick("torso");
             // document.getElementById('Torso').style.fill = '#b52d38';
            }}
          />
          ...
          <path
            ...
            transform="translate(-495.77 -161.37)"
            style={props.part().head ? highlight : {}}
            onClick={() => {
              partClick("head");
              //document.getElementById('Head').style.fill = '#b52d38';
            }}
          />
          ...
          <path
            ...
            transform="translate(-495.77 -161.37)"
            style={props.part().rarm ? highlight : {}}
            onClick={() => {
              partClick("rarm");
             // document.getElementById('RArm').style.fill = '#b52d38';
            }}
          />
          ...
          <path
            ...
            transform="translate(-495.77 -161.37)"
            style={props.part().rleg ? highlight : {}}
            onClick={() => {
              partClick("rleg");
             // document.getElementById('RLeg').style.fill = '#b52d38';
            }}
          />
          ...
          <path
            ...
            transform="translate(-495.77 -161.37)"
            style={props.part().lleg ? highlight : {}}
            onClick={() => {
              partClick("lleg");
             // document.getElementById('LLeg').style.fill = '#b52d38';
            }}
          />
          ...
          <path
            ...
            transform="translate(-495.77 -161.37)"
            style={props.part().larm ? highlight : {}}
            onClick={() => {
              partClick("larm");
              // document.getElementById('LArm').style.fill = '#b52d38';
            }}
          />
        </svg>
      </div>
