              ...
              <div className="my-2">
                ...
                <div className="text-black">
                  <select
                    ...
                    onInput={(e) => props.under18Clicked(e.target.value)}
                    value={props.childrenUnder18}
                  >
            ...
            <div className="flex flex-row"
              ...
              <div className="my-2">
                ...
                <div className="text-black">
                  <select
                    className="border bg-gray-200 text-black px-3 py-2 mt-1 mb-1 text-sm w-30"
                    onInput={(e) => props.above18Clicked(e.target.value)}
                    value={props.childrenAbove18}
                  >
                    <option value="0">None</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
              ...
              <div className="my-2">
                ...
                <div className="text-black">
                  <div className="text-black">
                    <select
                      className="border bg-gray-200 text-black px-3 py-2 mt-1 mb-1 text-sm w-30"
                      onInput={(e) => props.MaritalStatusClicked(e.target.value)}
                      value={props.hasSpouse ? "1" : "0"}
                    >
                ...
                >
                  <div className="my-2">
                    ...
                    <div className="text-black">
                      <select
                        className="border bg-gray-200 text-black px-3 py-2 mt-1 mb-1 text-sm w-30"
                        onInput={(e) => props.aidAndAttendanceClicked(e.target.value)}
                        value={props.aidAndAttendance ? "1" : "0"}
                      >
            ...
            >
              <div className="my-2">
                ...
                <div className="text-black">
                  <select
                    className="border bg-gray-200 text-black px-3 py-2 mt-1 mb-1 text-sm w-30"
                    onInput={(e) => props.dependentParentsClicked(e.target.value)}
                    value={props.dependentParents}
                  >
                    <option value="0">None</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
