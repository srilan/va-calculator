<script>
  import Parts from "../stores/Parts";
  ...
  const partClick = (partStr) => {
    ...
    Parts.update((partstore) => {
      return (partstore = newParts);
    });
    PartDisplay.update((pdisplay) => {
      let copy = pdisplay;
...
<div
  role="button"
  tabindex="0"
  class="w-2/3 lg:w-full relative pt-3"
  on:mouseenter={() => onHover(true)}
  on:mouseleave={() => onHover(false)}
>
  <div
    class="flex min-w-[150px] justify-between ps-4 pe-3 pt-1.5 py-1 bg-[#184997] mt-2 w-full text-white bebas md:text-xl lg:text-2xl rounded-tl-xl rounded-br-xl"
  >
    <span class="pe-2 none tracking-wide"> {$PartDisplay.display} </span>
    <img src={Down} alt="Arrow" class="w-4" />
  </div>
  {#if hovered}
    <div
      class="bg-white w-full py-3 ps-4 pe-2 absolute border-2 border-[#184997]"
    >
      <PartOption text="Head" on:click={() => partClick("head")} />
      <PartOption text="Left Arm" on:click={() => partClick("larm")} />
      <PartOption text="Right Arm" on:click={() => partClick("rarm")} />
      <PartOption text="Torso" on:click={() => partClick("torso")} />
      <PartOption text="Left Leg" on:click={() => partClick("lleg")} />
      <PartOption text="Right Leg" on:click={() => partClick("rleg")} />
      <PartOption text="Others" on:click={() => partClick("others")} />
    </div>
  {/if}
</div>
...
<div class="my-4">
  ...
  >
    <path
      ...
      role="button"
      tabindex="0"
      on:click={() => partClick("torso")}
    />

    <path
      id="Head"
      class="cls-2"
      class:highlight={part.head}
      ...
      role="button"
      tabindex="0"
      on:click={() => partClick("head")}
    />

    <path
      id="LArm"
      class="cls-2"
      class:highlight={part.larm}
      ...
      role="button"
      tabindex="0"
      on:click={() => partClick("larm")}
    />

    <path
      id="LLeg"
      class="cls-2"
      class:highlight={part.lleg}
      ...
      role="button"
      tabindex="0"
      on:click={() => partClick("lleg")}
    />

    <path
      id="RLeg"
      class="cls-2"
      class:highlight={part.rleg}
      ...
      role="button"
      tabindex="0"
      on:click={() => partClick("rleg")}
    />

    <path
      id="RArm"
      class="cls-2"
      class:highlight={part.rarm}
